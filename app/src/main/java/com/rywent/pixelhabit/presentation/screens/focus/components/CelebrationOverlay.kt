...
import com.rywent.pixelhabit.presentation.screens.focus.CelebrationType
...
fun CelebrationOverlay(
    ...
    LaunchedEffect(Unit) {
        ...
        val delayMs = if (type == CelebrationType.FULL_SESSION) 4200L else 3200L
    ...
    Box(
        ...
        Surface(
            ...
            Column(
                ...
                Icon(
                    imageVector = if (type == CelebrationType.FULL_SESSION)
                        Icons.Rounded.CheckCircle else Icons.Rounded.Timer,
